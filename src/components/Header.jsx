            ...
            <div className="border-b">
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center gap-4">
                    ...
                    <div className="text-2xl font-bold text-blue-900 flex items-center gap-2">
                        <LocalGroceryStoreIcon className="text-cyan-500" style={{ fontSize: isMobile ? "28px" : "32px" }} />
                        <span className={isMobile ? "text-lg" : "text-2xl"}>GroceryHub</span>
                    </div>

                    {/* Desktop: Location and Search */}
                    {!isMobile && (
                        <>
                            {/* Location Search */}
                            <button 
